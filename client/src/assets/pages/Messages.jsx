    ...
    <div className='min-h-screen relative bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Connect with your friends and followers</p>
        </div>

        {/* Connected Users */}
        <div className='flex flex-col gap-3'>
          {dummyConnectionsData.map((user) => (
            <div key={user._id} className='w-full max-w-xl flex items-center gap-5 p-6 bg-white shadow rounded-md'>

              <img src={user.profile_picture} alt="" className='rounded-full w-12 h-12 object-cover' />
