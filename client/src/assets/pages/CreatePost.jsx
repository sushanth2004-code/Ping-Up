  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white' >
      <div className='max-w-6x1 mx-auto p-6'>
        ...
        {/* Form */}
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-x1 shadow-md
space-y-4'>
          {/* Header */}
...
rounded-md' alt="" />
                  <div onClick={() => setImages(images.filter((_, index) => index
                    !== i))} className='absolute hidden group-hover:flex justify-center items-center top-0 right-0 bottom-0 left-0 bg-black/40 rounded-md cursor-pointer'>
